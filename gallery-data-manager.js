...
class GalleryDataManager {
    ...
    renderImages(images) {
        ...
        images.forEach((imageData) => {
            ...
            thumbImg.alt = imageData.title || 'Japonská kaligrafie';
            thumbImg.setAttribute('onclick', `openModal();currentSlide(${imageIndex})`);
            ...
            fullImg.alt = imageData.title || 'Japonská kaligrafie';
